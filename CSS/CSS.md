...
.flex-items {
	...
	flex-basis: 150px;// esto es lo maximo que te podes achicar, es la minima dimension en direccion del eje principal
}
````
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTYzODE1Mzg5LDE4NDkzMjQ0MjIsMTIzOT
